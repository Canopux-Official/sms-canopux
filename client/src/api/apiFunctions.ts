...
export const getFeeStructures = () => crudRequest('get', '/admin/feeStructure/all');
export const getActiveFeeStructures = () => crudRequest('get', '/admin/feeStructure/getActive');
export const addFeeStructure = (data: unknown) => crudRequest('post', '/admin/feeStructure/add', data);
export const updateFeeStructure = (id: string, data: unknown) => crudRequest('put', `/admin/feeStructure/update/${id}`, data);
export const deleteFeeStructure = (id: string) => crudRequest('delete', `/admin/feeStructure/delete/${id}`);

// --- FEE ASSIGNMENT & PAYMENTS (Admin) ---
export const assignFee = (data: unknown) => crudRequest('post', '/admin/fee/assign', data);
export const getStudentFeeByAdmin = (studentId: string) => crudRequest('get', `/admin/fee/student/${studentId}`);
export const getPaymentsByStudent = (studentId: string) => crudRequest('get', `/admin/fee/payments/${studentId}`);
export const recordFeePayment = (data: unknown) => crudRequest('post', '/admin/fee/pay', data);
export const getFeeDues = (queryString?: string) =>
  crudRequest('get', `/admin/fee/dues${queryString ? `?${queryString}` : ''}`);
export const getFeeReports = (queryString?: string) =>
  crudRequest('get', `/admin/fee/reports${queryString ? `?${queryString}` : ''}`);

// --- FEE (Student) ---
export const getMyFee = () => crudRequest('get', '/student/fee/my');
export const getMyFeePayments = () => crudRequest('get', '/student/fee/my/payments');