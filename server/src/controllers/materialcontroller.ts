...
const deleteSubFolder = async (req: Request, res: Response) => {
    try {
        ...
        // Files are just links now (Google Drive, Dropbox, or anywhere else the
        // admin pasted a URL) — nothing external to clean up, so we can delete
        // the file records and the folder itself directly.
